...
- Refactored monorepo package structure: packages moved under `packages/@visual-yaml/`.

### Patch Changes

- Updated dependencies
  - @visual-yaml/core@0.3.0
...
- Updated dependencies
  - @visual-yaml/core@0.1.1

## 0.1.0

### Minor Changes

- Initial release of `@visual-yaml/react` — React components for visual-yaml.
- `VisualYaml` context provider with state management, history, and search.
- `YamlEditor` wrapper component for quick integration.
