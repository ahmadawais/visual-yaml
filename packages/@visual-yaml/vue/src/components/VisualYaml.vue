...
import type { StudioActions, StudioState } from "../provide-inject";
...
const tree = shallowRef<TreeState>(fromYaml(props.value));
...
function setTree(newTree: TreeState) {
	...
	emit("change", toYaml(newTree.root));
}
...
const state: StudioState = {
	...
	drillDownNodeId,
	expandedNodeIds,
	schema: computed<YamlSchema | null>(() => props.schema ?? null),
	searchQuery,
	searchMatches,
	searchMatchIndex,
	searchMatchNodeIds,
